...
<div class="jms-slider-wrapper">
	<div class="responisve-container">
		...
		{foreach from=$slider->slides item=slide}
			<div class="slide {$slide->class_suffix}" style="background:{$slide->bg_color} url({$root_url nofilter}modules/jmsslider/views/img/slides/{$slide->bg_image nofilter}) no-repeat center top;background-size:cover;" {if $slide->slide_link}onclick="document.location='{$slide->slide_link nofilter}';"{/if}>
