	...
	*}
	...
	<div class="wishlistLinkTop">
		...
		<div class="wishlisturl form-group">
				<label>{l s='Permalink' d='Shop.Theme'}:</label> <input type="text" class="form-control" value="{$link->getModuleLink('jmswishlist', 'view', ['token' => $token_wish])|escape:'html':'UTF-8'}" readonly="readonly" />
					...
					<div class="product-box">
						...
						<div class="product_infos">
							...
							<span class="wishlist_product_detail">
								...
								{/if}
								<br />{l s='Quantity' d='Shop.Theme'}:<input type="text" class="form-control" id="quantity_{$product.id_product}_{$product.id_product_attribute}" value="{$product.quantity|intval}" size="3"  />
								<br /><br />
