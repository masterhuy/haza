...
<div class="layout-tools">
		...
		<ul class="import-export">
			...
			<li><a class="export-link label-tooltip" data-original-title="Export Layout" href="{$link->getAdminLink('AdminJmspagebuilderPages') nofilter}&configure=jmspagebuilder&export_id_page={$selectedpage.id_page nofilter}"><i class="icon-download"></i></a></li>
...
<form name="adminForm" action="{$link->getAdminLink('AdminJmspagebuilderPages') nofilter}&configure=jmspagebuilder" method="post" enctype="multipart/form-data">
		...
		<input type="hidden" name="import_id_page" value="{$selectedpage.id_page nofilter}" />
</form>
</div>
<div class="language-form" style="display:none;">
<form name="adminForm" action="{$link->getAdminLink('AdminJmspagebuilderPages') nofilter}&configure=jmspagebuilder" method="post">
...
<div class="pagebuilder-panel">
	<div id="rowlist" class="lg-layout" data-id="{$selectedpage.id_page nofilter}">
	<div class="rowlist">
...
<input id="current_url" type="hidden" name="current_url" value="{$link->getAdminLink('AdminJmspagebuilderPages') nofilter}&configure=jmspagebuilder&editAddon=1" />
<input id="backend_url" type="hidden" name="backend_url" value="{$link->getAdminLink('AdminJmspagebuilderPages') nofilter}" />
<div class="hidden">
...
<div class="hidden">
	<div class="column-settings">
		...
		<div class="form-group lg_col">
			<label>{l s='Medium Layout' d='Modules.JmsPagebuilder'}</label>
			<select data-attrname="lg_col" class="form-control addon-input">
			...
			<p class="help-block">Set the class of this column for medium devices >=992px</p>
		</div>
...
<form name="layoutForm" action="{$link->getAdminLink('AdminJmspagebuilderPages') nofilter}&configure=jmspagebuilder" method="post">
