...
<div id="desktop-header" class="header-{$jmsSetting.header_layout} {if $jmsSetting.header_class} {$jmsSetting.header_class}{/if}">
    {if $jmsSetting.header_layout == 1}
        {include file='_partials/headers/header-1.tpl'}
    {elseif $jmsSetting.header_layout == 2}
        {include file='_partials/headers/header-2.tpl'}
    {elseif $jmsSetting.header_layout == 3}
        {include file='_partials/headers/header-3.tpl'}
    {elseif $jmsSetting.header_layout == 4}
        {include file='_partials/headers/header-4.tpl'}
    {elseif $jmsSetting.header_layout == 5}
        {include file='_partials/headers/header-5.tpl'}
    {elseif $jmsSetting.header_layout == 6}
...
<div id="mobile-header" class="header-mobile-{$jmsSetting.header_mobile_layout} {if $jmsSetting.header_class} {$jmsSetting.header_class}{/if}">
    {if $jmsSetting.header_mobile_layout == 1}
        {include file='_partials/headers/header-mobile-1.tpl'}
    {elseif $jmsSetting.header_mobile_layout == 2}
        {include file='_partials/headers/header-mobile-2.tpl'}
    {elseif $jmsSetting.header_mobile_layout == 3}
