...
{/block}
{if $jmsSetting.login_page_layout == 'layout-1'}
    {include file='customer/_partials/login/layout-1.tpl'}
{elseif $jmsSetting.login_page_layout == 'layout-2'}
    {include file='customer/_partials/login/layout-2.tpl'}
{elseif $jmsSetting.login_page_layout == 'layout-3'}
    {include file='customer/_partials/login/layout-3.tpl'}
{elseif $jmsSetting.login_page_layout == 'layout-4'}
