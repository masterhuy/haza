<?php
/* Smarty version 3.1.33, created on 2020-03-04 07:04:52
...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5e5f5314728145_03617728',
...
function content_5e5f5314728145_03617728 (Smarty_Internal_Template $_smarty_tpl) {
...
" <?php if ($_smarty_tpl->tpl_vars['page']->value['id_page'] == $_smarty_tpl->tpl_vars['selectedpage']->value['id_page']) {?>selected="selected"<?php }?>><?php ob_start();
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
		...
		<ul class="import-export">
			...
			<li><a class="export-link label-tooltip" data-original-title="Export Layout" href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminJmspagebuilderPages');?>
&configure=jmspagebuilder&export_id_page=<?php echo $_smarty_tpl->tpl_vars['selectedpage']->value['id_page'];?>
...
<form name="adminForm" action="<?php echo $_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminJmspagebuilderPages');?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
 ...
 <strong>modules/jmspagebuilder/json/</strong> Folder</span>
		<input type="hidden" name="import_id_page" value="<?php echo $_smarty_tpl->tpl_vars['selectedpage']->value['id_page'];?>
" />
</form>
</div>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
	...
	<input type="hidden" name="lang_id_page" value="<?php echo $_smarty_tpl->tpl_vars['selectedpage']->value['id_page'];?>
" />
</form>
</div>
<div class="pagebuilder-panel">
	<div id="rowlist" class="lg-layout" data-id="<?php echo $_smarty_tpl->tpl_vars['selectedpage']->value['id_page'];?>
">
	<div class="rowlist">
		<?php
...
" />
<input id="current_url" type="hidden" name="current_url" value="<?php echo $_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminJmspagebuilderPages');?>
&configure=jmspagebuilder&editAddon=1" />
<input id="backend_url" type="hidden" name="backend_url" value="<?php echo $_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminJmspagebuilderPages');?>
" />
<div class="hidden">
...
" />
<form name="layoutForm" action="<?php echo $_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminJmspagebuilderPages');?>
&configure=jmspagebuilder" method="post">
<input type="hidden" name="jmsformjson" id="jmsformjson" value="" />
<input type="hidden" name="json_page_id" value="<?php echo $_smarty_tpl->tpl_vars['selectedpage']->value['id_page'];?>
" />
...
';
	...
	$(document).ready(function(){
		<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_15931883815e5f53147242c1_76982321', "autoload_tinyMCE");
?>
...
class Block_15931883815e5f53147242c1_76982321 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'autoload_tinyMCE' => 
  array (
    0 => 'Block_15931883815e5f53147242c1_76982321',
  ),
);
