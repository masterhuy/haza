...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5de88ea11d80e0_89002723',
...
function content_5de88ea11d80e0_89002723 (Smarty_Internal_Template $_smarty_tpl) {
...
">
	<a href="#" class="cart-icon" data-toggle="dropdown" aria-expanded="false">
...
"></i><span class="ajax_cart_quantity"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cart']->value['products_count'], ENT_QUOTES, 'UTF-8');?>
</span>
	</a>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
					...
					<div class="cart-button">
									<?php if (in_array('checkout',$_smarty_tpl->tpl_vars['jmsSetting']->value['cart_links'])) {?>
...
" class="btn btn-primary checkout-btn"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Checkout','d'=>'Shop.Theme.Actions'),$_smarty_tpl ) );?>
									...
									<?php }?>
									<?php if (in_array('cart',$_smarty_tpl->tpl_vars['jmsSetting']->value['cart_links'])) {?>
