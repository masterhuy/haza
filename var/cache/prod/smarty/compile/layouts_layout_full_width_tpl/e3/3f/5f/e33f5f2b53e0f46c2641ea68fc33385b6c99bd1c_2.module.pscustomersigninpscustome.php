...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5dea2c9b3a2e94_36906813',
...
function content_5dea2c9b3a2e94_36906813 (Smarty_Internal_Template $_smarty_tpl) {
?><div id="_desktop_user_info" class="col-auto">
	<div class="user-info btn-group">
      ...
      <?php }?>
			<a href="#" class="account" data-toggle="dropdown"><i class="ptw-icon <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['customersignin_icon']->value, ENT_QUOTES, 'UTF-8');?>
"></i></a>
...
if ($_smarty_tpl->tpl_vars['jmsSetting']->value['customersignin_class']) {?> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['jmsSetting']->value['customersignin_class'], ENT_QUOTES, 'UTF-8');
        ...
        <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['customerName']->value, ENT_QUOTES, 'UTF-8');?>
				...
				<ul>
					<?php if (in_array('my-account',$_smarty_tpl->tpl_vars['jmsSetting']->value['customersignin_logged_links'])) {?>
...
"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'My Account','d'=>'Shop.Theme.Actions'),$_smarty_tpl ) );?>
          ...
          <?php }?>
          <?php if (in_array('my-orders',$_smarty_tpl->tpl_vars['jmsSetting']->value['customersignin_logged_links'])) {?>
          <li><a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('my-orders',true), ENT_QUOTES, 'UTF-8');?>
"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'My Order','d'=>'Shop.Theme.Actions'),$_smarty_tpl ) );?>
          ...
          <?php }?>
          <?php if (in_array('checkout',$_smarty_tpl->tpl_vars['jmsSetting']->value['customersignin_logged_links'])) {?>
...
" class="account" rel="nofollow"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Checkout','d'=>'Shop.Theme.CustomerAccount'),$_smarty_tpl ) );?>
          ...
          <?php }?>
          <?php if (in_array('logout',$_smarty_tpl->tpl_vars['jmsSetting']->value['customersignin_logged_links'])) {?>
...
if ($_smarty_tpl->tpl_vars['jmsSetting']->value['customersignin_class']) {?> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['jmsSetting']->value['customersignin_class'], ENT_QUOTES, 'UTF-8');
				...
				<ul>
          <?php if (in_array('register',$_smarty_tpl->tpl_vars['jmsSetting']->value['customersignin_notlogged_links'])) {?>
...
" class="account" rel="nofollow"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Register','d'=>'Shop.Theme.CustomerAccount'),$_smarty_tpl ) );?>
          ...
          <?php }?>
          <?php if (in_array('login',$_smarty_tpl->tpl_vars['jmsSetting']->value['customersignin_notlogged_links'])) {?>
