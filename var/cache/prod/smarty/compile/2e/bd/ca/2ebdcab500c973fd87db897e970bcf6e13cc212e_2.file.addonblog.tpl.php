<?php
/* Smarty version 3.1.33, created on 2020-01-30 08:35:33
  from 'D:\xamppp\htdocs\jms_haza\modules\jmspagebuilder\views\templates\hook\addonblog.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5e329555970e13_53724638',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '2ebdcab500c973fd87db897e970bcf6e13cc212e' => 
    array (
      0 => 'D:\\xamppp\\htdocs\\jms_haza\\modules\\jmspagebuilder\\views\\templates\\hook\\addonblog.tpl',
      1 => 1576224378,
      2 => 'file',
    ),
  ),
...
function content_5e329555970e13_53724638 (Smarty_Internal_Template $_smarty_tpl) {
...
" class="img-responsive" /></a>
			...
			<?php }?>
			<h4 class="post-title"><a href="<?php echo htmlspecialchars(smarty_modifier_replace(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( jmsblog::getPageLink('jmsblog-post',$_smarty_tpl->tpl_vars['params']->value),'htmlall','UTF-8' )),'&amp;','&'), ENT_QUOTES, 'UTF-8');?>
...
"><?php echo $_smarty_tpl->tpl_vars['post']->value['category_name'];?>
				...
				<li class="post-created"><i class="fa fa-calendar-o"></i> <?php echo htmlspecialchars(smarty_modifier_date_format(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['post']->value['created'],'html','UTF-8' )),'%b %e, %Y'), ENT_QUOTES, 'UTF-8');?>
</li>
				<?php }?>
			...
			<?php if ($_smarty_tpl->tpl_vars['show_readmore']->value == '1') {?>
				<a class="post-readmore"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'read more','d'=>'Modules.JmsPagebuilder'),$_smarty_tpl ) );?>
 ...</a>
			<?php }?>
		</div>
	<?php
