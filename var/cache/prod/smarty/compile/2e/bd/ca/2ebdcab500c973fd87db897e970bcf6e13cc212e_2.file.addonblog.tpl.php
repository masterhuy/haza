...
function content_5e37bf8342b2c0_22249233 (Smarty_Internal_Template $_smarty_tpl) {
...
"><?php echo $_smarty_tpl->tpl_vars['post']->value['category_name'];?>
				...
				<?php if ($_smarty_tpl->tpl_vars['show_readmore']->value == '1') {?>
					<a class="btn post-readmore"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'read more','d'=>'Modules.JmsPagebuilder'),$_smarty_tpl ) );?>
</a>
				<?php }?>
			</div>
		<?php
