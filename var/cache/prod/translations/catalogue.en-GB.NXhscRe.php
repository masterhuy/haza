...
',
  ...
  array (
    ...
    'The field %s is required.' => 'The %s field is required.',
  ...
  array (
    ...
    'Unit Price (tax excl.) (%d) is not valid (at line %d).' => 'Unit Price (VAT excl.) (%d) is not valid (at line %d).',
  ...
  array (
    ...
    'You can review this credit slip and download your invoice from the <a href="{history_url}">"My credit slips"</a> section of your account by clicking <a href="{my_account_url}">"My account"</a> on our shop.' => 'You can review this credit note and download your invoice from the <a href="{history_url}">"My credit notes"</a> section of your account by clicking <a href="{my_account_url}">"My account"</a> on our shop.',
    ...
    'We have generated a credit slip in your name for order with the reference <span><strong>{order_name}</strong></span>.' => 'We have generated a credit note in your name for order with the reference <span><strong>{order_name}</strong></span>.',
    ...
    'Your order with the reference <span><strong>{order_name}</strong></span> from <span><strong>{shop_name}</strong></span> has been canceled.' => 'Your order with the reference <span><strong>{order_name}</strong></span> from <span><strong>{shop_name}</strong></span> has been cancelled.',
...
Thanks for your patience.',
  ...
  array (
    ...
    'Upload an image file containing the color texture from your computer.' => 'Upload an image file containing the colour texture from your computer.',
    'This will override the HTML color!' => 'This will override the HTML colour!',
    'Save then add another value' => 'Save then add another value',
