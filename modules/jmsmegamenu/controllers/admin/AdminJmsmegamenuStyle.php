...
class AdminJmsmegamenuStyleController extends ModuleAdminController
{
    ...
    public function initPageHeaderToolbar()
    {
        ...
        $this->page_header_toolbar_btn['save_style'] = array(
              'href' => $this->context->link->getAdminLink('AdminJmsmegamenuStyle').'&saveStyle&menu_id='.$this->selected_menu['menu_id'],
              'desc' => $this->l('Save Menu Style', null, null, false),
              'icon' => 'process-icon-save'
        );
        $this->page_header_toolbar_btn['reset_style'] = array(
              'href' => $this->context->link->getAdminLink('AdminJmsmegamenuStyle').'&resetStyle&menu_id='.$this->selected_menu['menu_id'],
              'desc' => $this->l('Reset Menu Style', null, null, false),
    ...
    public function renderList()
    {
        ...
        /* Validate & process */
        if (Tools::isSubmit('submitStyle') || Tools::isSubmit('selectMenu')) {
    ...
    private function _postProcess()
    {
        ...
        if (count($errors)) {
            ...
            Tools::redirectAdmin($this->context->link->getAdminLink('AdminJmsmegamenuStyle', true).'&configure='.$this->name.'&tab_module='.$this->tab.'&module_name='.$this->name.'&menu_id='.$this->selected_menu['menu_id']);
        }
    }
    ...
    public function nav()
    {
        ...
        foreach ($items as $item) {
            $this->genItem((int)$item['mitem_id']);
        }
    }
