...
{capture name=path}{l s='Archive' d='Modules.JmsBlog'}-{$month nofilter}{/capture}
<h3 class="title-blog">{l s='Archive' d='Modules.JmsBlog'} : {$month nofilter}</h3>
	...
	<div class="post-list">
		{foreach from=$posts item=post}
			...
			<article class="blog-post">
				<h4 class="post-title"><a href="{jmsblog::getPageLink('jmsblog-post', $params) nofilter}">{$post.title|escape:'htmlall':'UTF-8'}</a></h4>
				<ul class="post-meta">
