...
class JmsblogTagModuleFrontController extends ModuleFrontController
{
    ...
    public function initContent()
    {
        ...
        $this->setTemplate('module:jmsblog/views/templates/front/tag.tpl');
    }
    public function getBreadcrumbLinks()
    {
        $tag = Tools::getValue('tag');
        $_link = JmsBlog::getPageLink('jmsblog-tag', array('tag' => $tag));
        $breadcrumb = parent::getBreadcrumbLinks();
        $breadcrumb['links'][] = array('title' => $this->l('Tag')." : ".$tag, 'url' => $_link );
        return $breadcrumb;
    }
