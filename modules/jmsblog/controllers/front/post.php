...
class JmsblogPostModuleFrontController extends ModuleFrontController
{
    ...
    public function getBreadcrumbLinks()
    {
        ...
        $category   = JmsBlogHelper::getCategoryByAlias($category_slug);
        $catparams = array(
            'category_id' => $category['category_id'],
            'slug' => $category_slug
        );
        $_catlink = JmsBlog::getPageLink('jmsblog-category', $catparams);
        $postparams = array(
            'post_id' => $post['post_id'],
            'category_slug' => $category_slug,
            'slug' => $post['alias']
        );
        $_postlink = JmsBlog::getPageLink('jmsblog-post', $postparams);
