...
class JmsblogArchiveModuleFrontController extends ModuleFrontController
{
    ...
    public function initContent()
    {
        ...
        $this->setTemplate('module:jmsblog/views/templates/front/archive.tpl');
    }
    public function getBreadcrumbLinks()
    {
        $_month = Tools::getValue('archive');
        $_link = JmsBlog::getPageLink('jmsblog-archive', array('archive' => $_month));
        $breadcrumb = parent::getBreadcrumbLinks();
        $breadcrumb['links'][] = array('title' => $this->l('Archive')." : ".$_month, 'url' => $_link );
        return $breadcrumb;
    }
    public function getPosts($_month = '')
    {
