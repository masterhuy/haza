...
class JmsPage extends ObjectModel
{
    public $title;
    public $css_file;
    public $js_file;
    ...
    public function add($autodate = true, $null_values = false)
    {
        ...
        $res &= Db::getInstance()->execute('INSERT INTO `'._DB_PREFIX_.'jmspagebuilder` (`id_page`,`id_shop` ) VALUES('.(int)$this->id.','.(int)$id_shop.')');
        return $res;
    }
