...
class JmsPagesForm
{
    ...
    public function getPagesTabForm()
    {
        return array(
            'form' => array(
                'childForms' => array(
                    'jms-shop-page'  => $this->module->l('Shop Page', 'PagesForm'),
                    'jms-product-page'  => $this->module->l('Product Page', 'PagesForm'),
                    'jms-login-page'  => $this->module->l('Login Page', 'PagesForm'),
                    'jms-contact-page'  => $this->module->l('Contact Page', 'PagesForm'),
