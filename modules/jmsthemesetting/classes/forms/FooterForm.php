...
class JmsFooterForm
{
    ...
    public function getFooterTabForm()
    {
        return array(
            'form' => array(
                'childForms' => array(
                    'jms-footer-layout'  => $this->module->l('Footer Layout', 'FooterForm'),
                    'jms-footer-setting'  => $this->module->l('Footer Style', 'FooterForm'),
                    'jms-footer-top'  => $this->module->l('Footer Top', 'FooterForm'),
                    'jms-footer-copyright'  => $this->module->l('Copyright', 'FooterForm'),
                ),
                'legend' => array(
        ...
        return array(
            'form' => array(
                ...
                'legend' => array(
                    ...
                    'icon' => 'icon-cogs',
                    'id' => 'jms-footer-setting'
                ),
                'input' => array(
                    array(
                        'type' => 'select',
                        'label' => $this->module->l('Width', 'FooterForm'),
                        'name' => 'footer_width',
                        'options' => array(
                            'query' => array(
                                array(
                                    'id_option' => 'container',
                                    'name' => $this->module->l('Container', 'FooterForm'),
                                ),
                                array(
                                    'id_option' => 'fullwidth',
                                    'name' => $this->module->l('FullWidth', 'FooterForm'),
                                ),
                            ),
                            'id' => 'id_option',
                            'name' => 'name',
