...
class JmsMenuForm
{
    ...
    public function __construct()
    {
        ...
        $this->menus = JmsMegaMenuHelper::getMenus();
    }
    ...
    public function getMenuTabForm()
    {
        return array(
            'form' => array(
                'childForms' => array(
                    'jms-menu-hor'  => $this->module->l('Horizontal Menu', 'MenuForm'),
                    'jms-menu-ver'  => $this->module->l('Vertical Menu', 'MenuForm'),
                    'jms-menu-mobi'  => $this->module->l('Mobile Menu', 'MenuForm')
                ),
                'legend' => array(
    ...
    public function getHorMenuForm()
    {
        return array(
            'form' => array(
                'child' => true,
                'legend' => array(
                    'title' => $this->module->l('Horizontal Menu', 'MenuForm'),
                    'icon' => 'icon-cogs',
                    'id' => 'jms-menu-hor'
                ),
                'input' => array(
