...
require_once(dirname(__FILE__).'/jmswishlist.php');
...
if ($context->customer->isLogged())
{
	...
	if (empty($id_wishlist) === false)
	{
		...
		else
		{
			...
			$module = new JmsWishList();

			if (Tools::file_exists_cache(_PS_THEME_DIR_.'modules/jmswishlist/views/templates/front/managewishlist.tpl'))
				$context->smarty->display(_PS_THEME_DIR_.'modules/jmswishlist/views/templates/front/managewishlist.tpl');
